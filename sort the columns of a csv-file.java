...
public class Kata
{
    ...
    {
        int lines = StringUtils.countMatches(csvFileContent, "\n") + 1;
        int datas = (StringUtils.countMatches(csvFileContent, ";") + lines) / lines;
        String[][] data = new String[datas][lines];

        String[] line = csvFileContent.split("\n");
        int count = 0;
        for(int i = 0; i < lines; i++){
            String[] dat = line[i].split(";");
        ...
        System.out.println(Arrays.toString(sortedLine));
        
        // String[] sortedOrder = new String[data];
        // for(int i = 0; i < lines; i++){
